      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
          <div className="max-w-2xl w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800 p-6">
            ...
            <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 rounded-md p-4 mb-4">
              <p className="text-sm font-medium text-red-800 dark:text-red-400 mb-1">
                Error:
              </p>
              <p className="text-sm text-red-700 dark:text-red-500 font-mono break-all">
                {errorMessage}
              </p>
            </div>
